...
GRPC_UPB_DLL extern const upb_MiniTable envoy__type__v3__Percent_msg_init;
extern const upb_MiniTable* envoy__type__v3__Percent_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__type__v3__FractionalPercent_msg_init;
