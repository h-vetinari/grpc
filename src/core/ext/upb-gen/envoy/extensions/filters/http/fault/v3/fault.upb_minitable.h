...
GRPC_UPB_DLL extern const upb_MiniTable envoy__extensions__filters__http__fault__v3__FaultAbort_msg_init;
extern const upb_MiniTable* envoy__extensions__filters__http__fault__v3__FaultAbort_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__extensions__filters__http__fault__v3__FaultAbort__HeaderAbort_msg_init;
extern const upb_MiniTable* envoy__extensions__filters__http__fault__v3__FaultAbort__HeaderAbort_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__extensions__filters__http__fault__v3__HTTPFault_msg_init;
