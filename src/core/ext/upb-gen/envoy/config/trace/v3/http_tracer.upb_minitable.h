...
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__trace__v3__Tracing_msg_init;
extern const upb_MiniTable* envoy__config__trace__v3__Tracing_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__trace__v3__Tracing__Http_msg_init;
