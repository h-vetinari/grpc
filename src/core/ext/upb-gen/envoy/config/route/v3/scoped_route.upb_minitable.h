...
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__ScopedRouteConfiguration_msg_init;
extern const upb_MiniTable* envoy__config__route__v3__ScopedRouteConfiguration_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__ScopedRouteConfiguration__Key_msg_init;
extern const upb_MiniTable* envoy__config__route__v3__ScopedRouteConfiguration__Key_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__ScopedRouteConfiguration__Key__Fragment_msg_init;
