...
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__RouteConfiguration_msg_init;
extern const upb_MiniTable* envoy__config__route__v3__RouteConfiguration_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__RouteConfiguration__TypedPerFilterConfigEntry_msg_init;
extern const upb_MiniTable* envoy__config__route__v3__RouteConfiguration__TypedPerFilterConfigEntry_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__route__v3__Vhds_msg_init;
