...
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__UpstreamLocalityStats_msg_init;
extern const upb_MiniTable* envoy__config__endpoint__v3__UpstreamLocalityStats_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__UpstreamEndpointStats_msg_init;
extern const upb_MiniTable* envoy__config__endpoint__v3__UpstreamEndpointStats_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__EndpointLoadMetricStats_msg_init;
extern const upb_MiniTable* envoy__config__endpoint__v3__EndpointLoadMetricStats_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__UnnamedEndpointLoadMetricStats_msg_init;
extern const upb_MiniTable* envoy__config__endpoint__v3__UnnamedEndpointLoadMetricStats_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__ClusterStats_msg_init;
extern const upb_MiniTable* envoy__config__endpoint__v3__ClusterStats_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__config__endpoint__v3__ClusterStats__DroppedRequests_msg_init;
