...
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__ConfigDump_msg_init;
extern const upb_MiniTable* envoy__admin__v3__ConfigDump_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__BootstrapConfigDump_msg_init;
extern const upb_MiniTable* envoy__admin__v3__BootstrapConfigDump_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__SecretsConfigDump_msg_init;
extern const upb_MiniTable* envoy__admin__v3__SecretsConfigDump_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__SecretsConfigDump__DynamicSecret_msg_init;
extern const upb_MiniTable* envoy__admin__v3__SecretsConfigDump__DynamicSecret_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__SecretsConfigDump__StaticSecret_msg_init;
