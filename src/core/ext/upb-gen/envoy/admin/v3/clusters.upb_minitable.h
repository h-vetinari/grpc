...
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__Clusters_msg_init;
extern const upb_MiniTable* envoy__admin__v3__Clusters_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__ClusterStatus_msg_init;
extern const upb_MiniTable* envoy__admin__v3__ClusterStatus_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__HostStatus_msg_init;
extern const upb_MiniTable* envoy__admin__v3__HostStatus_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__HostHealthStatus_msg_init;
