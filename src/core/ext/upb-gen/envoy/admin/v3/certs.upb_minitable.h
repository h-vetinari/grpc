...
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__Certificates_msg_init;
extern const upb_MiniTable* envoy__admin__v3__Certificates_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__Certificate_msg_init;
extern const upb_MiniTable* envoy__admin__v3__Certificate_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__CertificateDetails_msg_init;
extern const upb_MiniTable* envoy__admin__v3__CertificateDetails_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__CertificateDetails__OcspDetails_msg_init;
extern const upb_MiniTable* envoy__admin__v3__CertificateDetails__OcspDetails_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__admin__v3__SubjectAlternateName_msg_init;
