...
GRPC_UPB_DLL extern const upb_MiniTable envoy__service__status__v3__ClientStatusRequest_msg_init;
extern const upb_MiniTable* envoy__service__status__v3__ClientStatusRequest_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__service__status__v3__PerXdsConfig_msg_init;
extern const upb_MiniTable* envoy__service__status__v3__PerXdsConfig_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__service__status__v3__ClientConfig_msg_init;
extern const upb_MiniTable* envoy__service__status__v3__ClientConfig_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__service__status__v3__ClientConfig__GenericXdsConfig_msg_init;
extern const upb_MiniTable* envoy__service__status__v3__ClientConfig__GenericXdsConfig_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable envoy__service__status__v3__ClientStatusResponse_msg_init;
