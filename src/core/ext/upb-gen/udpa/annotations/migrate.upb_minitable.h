...
GRPC_UPB_DLL extern const upb_MiniTable udpa__annotations__MigrateAnnotation_msg_init;
extern const upb_MiniTable* udpa__annotations__MigrateAnnotation_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable udpa__annotations__FieldMigrateAnnotation_msg_init;
extern const upb_MiniTable* udpa__annotations__FieldMigrateAnnotation_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable udpa__annotations__FileMigrateAnnotation_msg_init;
