...
GRPC_UPB_DLL extern const upb_MiniTable xds__core__v3__ResourceLocator_msg_init;
extern const upb_MiniTable* xds__core__v3__ResourceLocator_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable xds__core__v3__ResourceLocator__Directive_msg_init;
