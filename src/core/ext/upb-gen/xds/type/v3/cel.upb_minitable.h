...
GRPC_UPB_DLL extern const upb_MiniTable xds__type__v3__CelExpression_msg_init;
extern const upb_MiniTable* xds__type__v3__CelExpression_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable xds__type__v3__CelExtractString_msg_init;
