...
GRPC_UPB_DLL extern const upb_MiniTable xds__annotations__v3__MigrateAnnotation_msg_init;
extern const upb_MiniTable* xds__annotations__v3__MigrateAnnotation_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable xds__annotations__v3__FieldMigrateAnnotation_msg_init;
extern const upb_MiniTable* xds__annotations__v3__FieldMigrateAnnotation_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable xds__annotations__v3__FileMigrateAnnotation_msg_init;
