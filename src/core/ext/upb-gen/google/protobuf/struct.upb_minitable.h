...
GRPC_UPB_DLL extern const upb_MiniTable google__protobuf__Struct_msg_init;
extern const upb_MiniTable* google__protobuf__Struct_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable google__protobuf__Struct__FieldsEntry_msg_init;
extern const upb_MiniTable* google__protobuf__Struct__FieldsEntry_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable google__protobuf__Value_msg_init;
extern const upb_MiniTable* google__protobuf__Value_msg_init_ptr;
GRPC_UPB_DLL extern const upb_MiniTable google__protobuf__ListValue_msg_init;
